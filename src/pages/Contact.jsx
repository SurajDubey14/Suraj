        ...
        <form onSubmit={handleFormSubmit}>
          <div className="flex flex-col md:flex-row gap-4 py-4">
            <input
              ...
              name="fullname"
              required
              className="border w-full px-4 py-2 text-white shadow-lg rounded-xl border-[#3f3d3b]"
          ...
          <textarea
            name="message"
            required
            className="border w-full p-4 h-28 text-white shadow-lg rounded-xl border-[#3f3d3b]"
          ...
          <div className="py-4 flex justify-end">
            <button
              type="submit"
              className="hover:text-yellow-300 flex items-center gap-2 cursor-pointer border px-5 py-3 text-white shadow-lg rounded-xl border-[#3f3d3b]"
            >
              <RiSendPlaneLine />
              Send Message
            </button>
