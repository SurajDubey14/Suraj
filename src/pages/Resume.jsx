...
const Resume = () => {
  return (
    <div className="min-h-screen font-sans text-white ">
      <div className="shadow-xl rounded-xl p-8 space-y-12">
        {/* Education */}
        <section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm">GNIOT, AKTU — Greater Noida, India (July 2020 – July 2024)</p>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-semibold">Full Stack Developer – Colibyt Technology</h3>
              <p className="text-sm">Sec-62, Noida | Sept 2024 – Present</p>
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>Led frontend team using React, Node.js & MySQL</li>
                <li>Worked closely with PMs, designers & stakeholders to improve UX</li>
              </ul>
            </div>
            <div>
              <h3 className="text-xl font-semibold">Full Stack Developer – Publicis Groupe (Digitas)</h3>
              <p className="text-sm">Gurugram, Haryana | May 2024 – Aug 2024</p>
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>Built web apps using React.js, Firebase, Node.js & MongoDB</li>
